...
> 2026-05-17 정렬 메모: 이 문서는 초기 full-matrix 설계 기록이다. 현재 구현 기준은 `docs/presentation/`의 SkillProbe 발표자료이며, `configs/pilot.yaml`의 85 selected skills × 3 models × 3 prompt conditions decision PoC와 `configs/experiment.yaml`의 4-stage closed-loop 설계를 우선한다.
